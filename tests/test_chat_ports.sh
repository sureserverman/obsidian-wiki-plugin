...
for f in apply-chat.py build-chat-worklist.py build-index.py chat_records.py import-chat.py preview-chat.py review-media.py sanitize-chat.py validate-chat.py vault-write-protocol.py vault_write_protocol.py; do cmp -s "$C/$f" "$P/$f"; done
